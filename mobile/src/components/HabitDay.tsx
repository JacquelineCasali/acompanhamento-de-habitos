...
import { genereteProgressPercetage } from "../utils/generate-progress-porcentage";
...
interface Propos extends TouchableOpacityProps {
...
export function HabitDay({
  ...
  const amountAccomplishedPercentage =
    amountOfHabits > 0
      ? genereteProgressPercetage(amountOfHabits, amountCompleted)
      : 0;
